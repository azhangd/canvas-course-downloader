/*!
 * client-zip v2.5.0 — A tiny client-side streaming ZIP generator
 * https://github.com/Touffy/client-zip
 * Copyright (c) David Junger. MIT License.
 * Vendored from https://unpkg.com/client-zip@2.5.0/worker.js
 */
